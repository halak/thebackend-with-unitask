...
namespace Halak
{
    internal static class Asynchronizer
    {
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation(Action<Backend.BackendCallback> function, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1>(Action<T1, Backend.BackendCallback> function, T1 arg1, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1, T2>(Action<T1, T2, Backend.BackendCallback> function, T1 arg1, T2 arg2, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1, T2, T3>(Action<T1, T2, T3, Backend.BackendCallback> function, T1 arg1, T2 arg2, T3 arg3, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1, T2, T3, T4>(Action<T1, T2, T3, T4, Backend.BackendCallback> function, T1 arg1, T2 arg2, T3 arg3, T4 arg4, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1, T2, T3, T4, T5>(Action<T1, T2, T3, T4, T5, Backend.BackendCallback> function, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
        ...
        public static UniTask<BackendReturnObject> MakeWithCancellation<T1, T2, T3, T4, T5, T6>(Action<T1, T2, T3, T4, T5, T6, Backend.BackendCallback> function, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, CancellationToken cancellationToken)
        {
            if (function == null)
                throw new ArgumentNullException(nameof(function));
